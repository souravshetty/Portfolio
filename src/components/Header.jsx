...
const Header = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[60vh] text-white relative" style={{ background: '#232946' }}>
      ...
      <div className="relative w-40 h-40 mb-4 flex items-center justify-center z-10">
        <img
      ...
      {/* Name and Title */}
      <h1 ref={headingRef} className="text-4xl md:text-5xl font-bold mb-2 z-20">Hi, I'm Sourav Shetty <span role="img" aria-label="wave">👋</span></h1>
      ...
      <div className="mt-8 text-center z-20 flex flex-col items-center space-y-2">
        <span className="h-10 mt-2 text-lg md:text-2xl font-normal text-black dark:text-white">
          {currentPhrase}
